...
public class Vraagtest {
    ...
    public void testGetNummer(){
        ...
        keuzes.add("C. Aarde");
        keuzes.add("D. Pluto");
        Vraag nummer = new Vraag(keuzes, "Hoe heet de 3e planeet van ons zonnestelsel?", 'C', 10);
    ...
    public void testGetMcvraag(){
        ...
        keuzes.add("C. Aarde");
        keuzes.add("D. Pluto");
        Vraag vraag = new Vraag(keuzes, "Hoe heet de 3e planeet van ons zonnestelsel?", 'C', 10);
    ...
    public void testGetMcantwoord() {
        ...
        keuzes.add("C. Aarde");
        keuzes.add("D. Pluto");
        Vraag antwoord = new Vraag(keuzes, "Hoe heet de 3e planeet van ons zonnestelsel?", 'C', 10);
